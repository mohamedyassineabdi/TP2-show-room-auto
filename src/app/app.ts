...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, HeadBar, SearchBar, CommonModule],
  templateUrl: './app.html',
  styleUrl: './app.css'
})
export class AppComponent {
  protected readonly title = signal('show_room_auto');
  ...
  onEscape(event: Event) {
    ...
    const key = keyboardEvent && keyboardEvent.key ? keyboardEvent.key : '';
